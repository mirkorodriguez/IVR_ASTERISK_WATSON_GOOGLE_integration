...
public class CentralMasterResponseDTO {
...
//    private String centralAccessPwd;
    ...
    private List<ExtensionResponseDTO> extensionResponseDTOList;
...
//    }
	...
	public List<ExtensionResponseDTO> getExtensionResponseDTOList() {
		return extensionResponseDTOList;
	}

	public void setExtensionResponseDTOList(List<ExtensionResponseDTO> extensionResponseDTOList) {
		this.extensionResponseDTOList = extensionResponseDTOList;
	}
